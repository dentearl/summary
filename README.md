...
summary is a C program for getting the five number summary 
(plus sample size and standard deviation) on the command line 
(see wikipedia:Five-number summary). It is a partial 
refactoring of the R quantile() function from the R project 
